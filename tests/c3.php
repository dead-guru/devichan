...
if (!class_exists('\\Codeception\\Codecept') || !function_exists('codecept_is_path_absolute')) {
    ...
    require_once $projectDirectory . '/vendor/codeception/codeception/autoload.php';
}
...
$projectDirectory ??= dirname(__DIR__);
$configDistFile = $projectDirectory . DIRECTORY_SEPARATOR . 'codeception.dist.yml';
$configFile = $projectDirectory . DIRECTORY_SEPARATOR . 'codeception.yml';

if (isset($_SERVER['HTTP_X_CODECEPTION_CODECOVERAGE_CONFIG'])) {
    $configFile = $projectDirectory . DIRECTORY_SEPARATOR . $_SERVER['HTTP_X_CODECEPTION_CODECOVERAGE_CONFIG'];
}
